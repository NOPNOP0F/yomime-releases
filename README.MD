...
**[Download the APK](https://github.com/NOPNOP0F/yomime-releases/releases/latest)** - Requires Android 8.0 or newer. The current version is 1.1.0-beta.
...
<img alt="Dictionary page" width="220" src="assets/dictionary.png"> <img alt="Information about `目` kanji" width="220" src="assets/dictionary_kanji.png"> <img alt="Information about `日本語` word" width="220" src="assets/dictionary_word.png">
...
<img alt="Library page" width="220" src="assets/library.png"> <img alt="Information about Isekai Samurai from AniList" width="220" src="assets/library_media.png"> <img alt="AniList entry of Isekai Samurai" width="220" src="assets/library_media_entry.png"> <img alt="Activity page" width="220" src="assets/activity.png">
...
<img alt="Sumi theme" width="220" src="assets/theme_sumi.png"> <img alt="Sakura theme" width="220" src="assets/theme_sakura.png"> <img alt="Match theme" width="220" src="assets/theme_matcha.png">

<img alt="Reader page with two-page spread enabled on a tablet" src="assets/reader_two_page_tablet.png">

<img alt="Library page on a tablet" src="assets/library_tablet.png">

---

## Download

**[v1.1.0-beta](https://github.com/NOPNOP0F/yomime-releases/releases/latest)**
